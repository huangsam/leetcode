...
class Solution:
    def moveZeroes(self, nums: List[int]) -> None:
        ...
        Use a two-pointer approach: iterate through the array, and when a
        non-zero element is found, swap it with the element at the current "non-zero"
        position, then increment that position. This effectively moves all
